...
final class SPDateUtil
{
    ...
    static func isoFormat(date: Date) -> String
    {
    ...
    static func fromBirthdateFormat(_ birthdate: String) -> Date? {
        let formatter = DateFormatter()
    ...
    static func formattedTrackTime(_ timeInS: TimeInterval) -> String {
