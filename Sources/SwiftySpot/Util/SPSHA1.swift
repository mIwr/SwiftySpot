...
struct SPSHA1 {
    ...
    private struct context {
        ...
        var h:[UInt32]=[SPSHA1.h0,SPSHA1.h1,SPSHA1.h2,SPSHA1.h3,SPSHA1.h4]
     ...
     **************************************************/
    private static func process(data: inout Data) -> SPSHA1.context? {
        var context=SPSHA1.context()
     ...
     **************************************************/
    private static func hexString(_ context:SPSHA1.context?) -> String? {
     ...
     **************************************************/
    private static func dataFromFile(named filename:String) -> SPSHA1.context? {
