...
public enum SPInteractivity: SwiftProtobuf.Enum, Swift.CaseIterable {
...
public enum SPContentType: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
///Audio file source
public enum SPDownloadInfoStatus: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
...
public struct SPPlayIntentResponse: @unchecked Sendable {
...
public struct SPDownloadInfoResponse: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
