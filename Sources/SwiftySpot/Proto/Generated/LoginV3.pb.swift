...
struct SPLoginChallengeAnswerData {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct SPLoginChallengeAnswer {
  ...
  var code: SPLoginCodeAnswer {
    get {
      if case .code(let v)? = answer {return v}
      return SPLoginCodeAnswer()
    }
  ...
  enum OneOf_Answer: Equatable {
    ...
    case code(SPLoginCodeAnswer)

  #if !swift(>=4.1)
    static func ==(lhs: SPLoginChallengeAnswer.OneOf_Answer, rhs: SPLoginChallengeAnswer.OneOf_Answer) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
struct SPLoginV3Response {
  ...
  var challenge: SPLoginChallengesData {
    get {
  ...
  var userInfo: SPUserInfo {
    get {return _userInfo ?? SPUserInfo()}
  ...
  enum OneOf_Response: Equatable {
    ...
    case challenge(SPLoginChallengesData)
  ...
  fileprivate var _userInfo: SPUserInfo? = nil
}
...
extension SPUserInfo.Gender: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
struct SPLoginChallenge {
  ...
  var hashcash: SPLoginHashcashChallenge {
    get {
      if case .hashcash(let v)? = method {return v}
      return SPLoginHashcashChallenge()
    }
    set {method = .hashcash(newValue)}
  }

  var code: SPLoginCodeChallenge {
    get {
      if case .code(let v)? = method {return v}
      return SPLoginCodeChallenge()
    }
  ...
  enum OneOf_Method: Equatable {
    case hashcash(SPLoginHashcashChallenge)
    case code(SPLoginCodeChallenge)

  #if !swift(>=4.1)
    static func ==(lhs: SPLoginChallenge.OneOf_Method, rhs: SPLoginChallenge.OneOf_Method) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
struct SPLoginHashcashChallenge {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct SPLoginCodeChallenge {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var method: SPLoginCodeChallenge.Method = .unknown
...
extension SPLoginCodeChallenge.Method: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [SPLoginCodeChallenge.Method] = [
    .unknown,
    .sms,
  ]
}
...
extension SPPhoneNumber: @unchecked Sendable {}
extension SPLoginChallengeAnswerData: @unchecked Sendable {}
extension SPLoginChallengeAnswer: @unchecked Sendable {}
extension SPLoginChallengeAnswer.OneOf_Answer: @unchecked Sendable {}
extension SPHashcashAnswer: @unchecked Sendable {}
extension SPLoginCodeAnswer: @unchecked Sendable {}
...
extension SPUserInfo: @unchecked Sendable {}
extension SPUserInfo.Gender: @unchecked Sendable {}
extension SPLoginChallengesData: @unchecked Sendable {}
extension SPLoginChallenge: @unchecked Sendable {}
extension SPLoginChallenge.OneOf_Method: @unchecked Sendable {}
extension SPLoginHashcashChallenge: @unchecked Sendable {}
extension SPLoginCodeChallenge: @unchecked Sendable {}
extension SPLoginCodeChallenge.Method: @unchecked Sendable {}
...
extension SPLoginV3Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "LoginV3Request"
...
extension SPLoginCodeAnswer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: SPLoginCodeAnswer, rhs: SPLoginCodeAnswer) -> Bool {
...
extension SPLoginV3Response: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "LoginV3Response"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "auth"),
    2: .same(proto: "error"),
...
extension SPLoginChallenge: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: SPLoginHashcashChallenge?
        var hadOneofValue = false
...
extension SPLoginHashcashChallenge: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: SPLoginHashcashChallenge, rhs: SPLoginHashcashChallenge) -> Bool {
...
extension SPLoginCodeChallenge: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: SPLoginCodeChallenge, rhs: SPLoginCodeChallenge) -> Bool {
    if lhs.method != rhs.method {return false}
    if lhs.length != rhs.length {return false}
    if lhs.expiresInS != rhs.expiresInS {return false}
    if lhs.phone != rhs.phone {return false}
...
extension SPLoginCodeChallenge.Method: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "UNKNOWN"),
    1: .same(proto: "SMS"),
  ]
