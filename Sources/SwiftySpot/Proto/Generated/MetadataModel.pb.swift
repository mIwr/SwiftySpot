...
///Meta copyright type
public enum SPMetadataCopyrightType: SwiftProtobuf.Enum {
...
extension SPMetadataCopyrightType: CaseIterable {
...
public enum SPMetadataAlbumType: SwiftProtobuf.Enum {
  public typealias RawValue = Int
  case unknown // = 0
  case album // = 1
  case single // = 2
...
extension SPMetadataAlbumType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
///Artist role type
public enum SPMetadataArtistRole: SwiftProtobuf.Enum {
  public typealias RawValue = Int
  case unknown // = 0
  case mainArtist // = 1
...
extension SPMetadataArtistRole: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
public enum SPMetadataAudioFormat: SwiftProtobuf.Enum {
  public typealias RawValue = Int
  case oggVorbis96 // = 0
  case oggVorbis160 // = 1
  case oggVorbis320 // = 2
...
extension SPMetadataAudioFormat: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
///Bio meta data
public struct SPMetadataBiography {
...
public struct SPMetadataExternalId {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///Images array
public struct SPMetadataImageGroup {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct SPMetadataSalePeriod {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct SPMetadataRestriction {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct SPMetadataAvailability {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///Copyright meta info
public struct SPMetadataCopyright {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct SPMetadataContentRating {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///Licensor meta info
public struct SPMetadataLicensor {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct SPMetadataLocalizedString {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct SPMetadataActivityPeriod {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct SPMetadataArtistWithRole {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct SPMetadataAudioFile {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension SPMetadataCopyrightType: @unchecked Sendable {}
extension SPMetadataAlbumType: @unchecked Sendable {}
extension SPMetadataArtistRole: @unchecked Sendable {}
extension SPMetadataAudioFormat: @unchecked Sendable {}
extension SPMetadataBiography: @unchecked Sendable {}
extension SPMetadataExternalId: @unchecked Sendable {}
extension SPMetadataImage: @unchecked Sendable {}
extension SPMetadataImageGroup: @unchecked Sendable {}
extension SPMetadataSalePeriod: @unchecked Sendable {}
extension SPMetadataRestriction: @unchecked Sendable {}
extension SPMetadataDate: @unchecked Sendable {}
extension SPMetadataAvailability: @unchecked Sendable {}
extension SPMetadataCopyright: @unchecked Sendable {}
extension SPMetadataContentRating: @unchecked Sendable {}
extension SPMetadataLicensor: @unchecked Sendable {}
extension SPMetadataBlock: @unchecked Sendable {}
extension SPMetadataLocalizedString: @unchecked Sendable {}
extension SPMetadataActivityPeriod: @unchecked Sendable {}
extension SPMetadataArtistWithRole: @unchecked Sendable {}
extension SPMetadataAudioFile: @unchecked Sendable {}
