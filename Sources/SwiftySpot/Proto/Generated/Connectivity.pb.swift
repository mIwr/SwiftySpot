...
struct SPConnectivity {
  ...
  var platform: SPPlatformSpecificData {
    get {return _platform ?? SPPlatformSpecificData()}
  ...
  fileprivate var _platform: SPPlatformSpecificData? = nil
}

struct SPPlatformSpecificData {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var data: SPPlatformSpecificData.OneOf_Data? = nil

  var android: SPNativeAndroidData {
    get {
      if case .android(let v)? = data {return v}
      return SPNativeAndroidData()
    }
    set {data = .android(newValue)}
  }

  var ios: SPNativeIOSData {
    get {
      if case .ios(let v)? = data {return v}
      return SPNativeIOSData()
    }
    set {data = .ios(newValue)}
  }

  var windows: SPNativeWindowsData {
    get {
      if case .windows(let v)? = data {return v}
      return SPNativeWindowsData()
    }
  ...
  enum OneOf_Data: Equatable {
    case android(SPNativeAndroidData)
    case ios(SPNativeIOSData)
    case windows(SPNativeWindowsData)

  #if !swift(>=4.1)
    static func ==(lhs: SPPlatformSpecificData.OneOf_Data, rhs: SPPlatformSpecificData.OneOf_Data) -> Bool {
...
extension SPPlatformSpecificData: @unchecked Sendable {}
extension SPPlatformSpecificData.OneOf_Data: @unchecked Sendable {}
extension SPNativeAndroidData: @unchecked Sendable {}
extension SPNativeIOSData: @unchecked Sendable {}
extension SPNativeWindowsData: @unchecked Sendable {}
...
extension SPConnectivity: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "Connectivity"
...
extension SPPlatformSpecificData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: SPPlatformSpecificData, rhs: SPPlatformSpecificData) -> Bool {
...
extension SPNativeAndroidData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: SPNativeAndroidData, rhs: SPNativeAndroidData) -> Bool {
...
extension SPNativeIOSData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: SPNativeIOSData, rhs: SPNativeIOSData) -> Bool {
...
extension SPNativeWindowsData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: SPNativeWindowsData, rhs: SPNativeWindowsData) -> Bool {
...
extension SPScreenInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "ScreenInfo"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "width"),
    2: .same(proto: "height"),
