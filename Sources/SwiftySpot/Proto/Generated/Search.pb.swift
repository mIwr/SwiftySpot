...
struct SPSearchAutocompleteViewResponse {
...
struct SPSearchMainViewResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct SPSearchRecommendations {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct SPSearchResultEntity {
  ...
  #if !swift(>=4.1)
    static func ==(lhs: SPSearchResultEntity.OneOf_Info, rhs: SPSearchResultEntity.OneOf_Info) -> Bool {
...
extension SPSearchAutocompleteViewResponse: @unchecked Sendable {}
extension SPSearchMainViewResponse: @unchecked Sendable {}
extension SPSearchRecommendations: @unchecked Sendable {}
extension SPSearchResultEntity: @unchecked Sendable {}
extension SPSearchResultEntity.OneOf_Info: @unchecked Sendable {}
