...
enum SPUserGender: SwiftProtobuf.Enum {
...
extension SPUserGender: CaseIterable {
...
enum SPCapability: SwiftProtobuf.Enum {
  typealias RawValue = Int
...
extension SPCapability: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
...
struct SPEmailAndPasswordIdentifier {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct SPCreateAccountResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  #if !swift(>=4.1)
    static func ==(lhs: SPCreateAccountResponse.OneOf_ResultCase, rhs: SPCreateAccountResponse.OneOf_ResultCase) -> Bool {
...
struct SPCreateAccountSuccessResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct SPCreateAccountErrorResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct SPCreateAccountChallengeResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct SPCompleteAccountCreationRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct SPCompleteAccountCreationResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  #if !swift(>=4.1)
    static func ==(lhs: SPCompleteAccountCreationResponse.OneOf_ResultCase, rhs: SPCompleteAccountCreationResponse.OneOf_ResultCase) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
struct SPCompleteAccountCreationSuccessResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct SPCompleteAccountCreationErrorResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension SPUserGender: @unchecked Sendable {}
extension SPCapability: @unchecked Sendable {}
extension SPCreateAccountRequest: @unchecked Sendable {}
extension SPAccountDetails: @unchecked Sendable {}
extension SPConsentFlags: @unchecked Sendable {}
extension SPEmailAndPasswordIdentifier: @unchecked Sendable {}
extension SPSignupClientInfo: @unchecked Sendable {}
extension SPTracking: @unchecked Sendable {}
extension SPCreateAccountResponse: @unchecked Sendable {}
extension SPCreateAccountResponse.OneOf_ResultCase: @unchecked Sendable {}
extension SPCreateAccountSuccessResponse: @unchecked Sendable {}
extension SPCreateAccountErrorResponse: @unchecked Sendable {}
extension SPCreateAccountChallengeResponse: @unchecked Sendable {}
extension SPCompleteAccountCreationRequest: @unchecked Sendable {}
extension SPCompleteAccountCreationResponse: @unchecked Sendable {}
extension SPCompleteAccountCreationResponse.OneOf_ResultCase: @unchecked Sendable {}
extension SPCompleteAccountCreationSuccessResponse: @unchecked Sendable {}
extension SPCompleteAccountCreationErrorResponse: @unchecked Sendable {}
